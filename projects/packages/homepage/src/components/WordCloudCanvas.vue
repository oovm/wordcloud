<template>
    <div class="card h-full">
        <div class="flex justify-between items-center mb-4">
            ...
            <div class="flex items-center space-x-2">
                ...
                <div class="flex items-center space-x-1 text-sm text-gray-600">
                    <button @click="zoomOut" class="btn-icon" :disabled="zoom <= 0.5">
                    ...
                    <button @click="zoomIn" class="btn-icon" :disabled="zoom >= 2">
                        <Icon icon="carbon:zoom-in" class="w-4 h-4" />
                    </button>
                </div>

                <!-- 重置视图 -->
                <button @click="resetView" class="btn-secondary text-sm">
        ...
        >
            <!-- 空状态 -->
            <div v-if="!elements.length && !isGenerating" class="absolute inset-0 flex-center text-gray-500">
            ...
            <!-- 生成中状态 -->
            <div v-if="isGenerating" class="absolute inset-0 flex-center bg-white bg-opacity-90">
                <div class="text-center">
                    <div
