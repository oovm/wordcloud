<template>
    <div v-if="visible" class="fixed inset-0 bg-black bg-opacity-50 flex-center z-50" @click="closeModal">
        <div class="bg-white rounded-xl max-w-4xl max-h-[90vh] mx-4 overflow-hidden" @click.stop>
            <!-- 头部 -->
            <div class="flex justify-between items-center p-6 border-b border-gray-200">
                ...
                <button @click="closeModal" class="btn-icon text-gray-400 hover:text-gray-600">
            ...
            <div class="flex justify-end items-center p-6 border-t border-gray-200 bg-gray-50">
                <div class="flex items-center space-x-4">
                    <span class="text-sm text-gray-500"> 版本 1.0.0 | 更多功能正在开发中 </span>
                    <button @click="closeModal" class="btn-primary">知道了</button>
                </div>
            </div>
        </div>
    </div>
